...
from debias_files.src.consts import get_basic_configurations, get_debias_files_from_config
...
class TransformerEncoder(object):
    ...
    def __init__(self,
        ...
        a = 1
        self.USE_DEBIASED, _, self.COLLECT_EMBEDDING_TABLE, _, _ ,_,_,_,_= get_basic_configurations(self.consts_config_str)
